  ...
  return (
    <section className="pt-10 pb-14 md:pt-20 md:pb-20 border-t border-gray-700 animate-fadeIn bg-gradient-to-r from-black via-gray-900 to-black">
      ...
      <div className="text-center mb-12 md:mb-16 px-6">
        <h2 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">How It Works</h2>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-12 px-6">
        {steps.map((item, idx) => (
          <div
            key={idx}
            className="text-center space-y-6 bg-gray-950 p-8 rounded-2xl shadow-xl hover:scale-[1.02] transition-all duration-300 border border-gray-700"
          >
            {/* Image */}
            ...
            <h3 className="text-xl md:text-2xl font-extrabold text-white tracking-tight leading-tight">{item.title}</h3>
      ...
      <div className="text-center mt-12 md:mt-16 px-6">
        <Link
          href="/mentors"
          className="bg-white text-black font-medium w-72 sm:w-auto px-8 py-4 rounded-lg text-base md:text-lg hover:bg-gray-100 hover:scale-105 hover:shadow-xl transition duration-300 shadow-lg inline-block"
        >
